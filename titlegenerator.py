...
def videoessaygenerator():
    while True:
        ...
        issue = ["forced diversity", "tiktok", "AI art", "smosh", "masturbation", "porn", "velma", "pedophillia", "beastiality", "necrophilia", "channel awesome", "creepshow art", "yandere dev", "keffals", "debate bros", "nikocado avocado", "mrbeast"]
        subject = issue[randint(0,16)]
